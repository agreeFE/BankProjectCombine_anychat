...
import cn.com.agree.idcamera.R;
    ...
    private void initView() {
        ...
        switch (mType) {
            ...
            case IDCardCamera.TYPE_IDCARD_BACK:
                ...
                break;
            case IDCardCamera.TYPE_BANKCARD:
                mIvCameraCrop.setImageResource(R.mipmap.camera_bankcard);
                break;
        }
        ...
        mCropImageView.crop(new CropListener() {
            ...
            public void onFinish(Bitmap bitmap) {
                ...
                if (FileUtils.createOrExistsDir(Constant.DIR_ROOT)) {
                    ...
                    }  else if (mType == IDCardCamera.TYPE_BANKCARD){
                         imagePath = buffer.append(Constant.DIR_ROOT).append(Constant.APP_NAME).append(".").append("bankCardCrop.jpg").toString();
                     }
