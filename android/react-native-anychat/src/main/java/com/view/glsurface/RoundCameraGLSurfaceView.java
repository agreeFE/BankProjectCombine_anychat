...
//                        if(width * height != 0 ){
//
//                            Rect rect = new Rect(view.getMeasuredWidth()/2- width /2 , view.getMeasuredHeight()/2 - height/2,
//                                    view.getMeasuredWidth()/2 + width /2, view.getMeasuredHeight()/2 + height/2);
