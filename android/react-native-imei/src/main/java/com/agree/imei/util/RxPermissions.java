...
public class RxPermissions {
    ...
    static final String TAG = "AnyChatRxPermissions";
    static final Object TRIGGER = new Object();
    private static Activity instanceActivity = null;
    private static RxPermissions instance;

    RxPermissionsFragment mRxPermissionsFragment;


    private RxPermissions(@NonNull Activity activity) {
        mRxPermissionsFragment = getRxPermissionsFragment(activity);
    }

    public static RxPermissions getIntance(Activity activity){
        if(instanceActivity == null){
            instance = new RxPermissions(activity);
        }else{
            instance = new RxPermissions(instanceActivity);
        }
        return instance;
    }
