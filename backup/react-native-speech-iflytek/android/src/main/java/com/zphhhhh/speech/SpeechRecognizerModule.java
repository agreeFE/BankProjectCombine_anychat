...
public class SpeechRecognizerModule extends ReactContextBaseJavaModule {
    ...
    private String[] RECORD_AUDIO_PERMISSIONS = new String[]{Manifest.permission.RECORD_AUDIO};
        ...
        getCurrentActivity().runOnUiThread(new Runnable() {
            ...
            public void run() {
                new RxPermissions(getCurrentActivity())
                        ...
                        .request(RECORD_AUDIO_PERMISSIONS)
                        .subscribe(new Consumer<Boolean>() {
                            ...
                            public void accept(@NonNull Boolean aBoolean) throws Exception {
                                if(aBoolean){
                                    ...
                                    SpeechRecognizerModule.this.onJSEvent(getReactApplicationContext(), "onInit", params);
    ...
    private void initInstance(String AppId) {
        if (mIat != null) {
            return;
        }
