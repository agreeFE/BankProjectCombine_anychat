            ...
            >
              {props.image ? (
                ...
                <Image
                  ...
                  source={require("../src/loading.gif")}
                />
              ) : null}
              {props.showText ? (
                <Text
      ...
      <TouchableWithoutFeedback onPress={this.onPress}>
        <View style={styles.maskStyle}>
          <View
            style={[
              styles.maskStyle,
              props.maskColor && { backgroundColor: props.maskColor },
              props.maskOpacity && { opacity: props.maskOpacity }
            ]}
          />
          {this.props.children}
        </View>
