...
module.exports = class Fund extends Component {
  constructor(props) {
    ...
    this.state = {
      showMoney: true,
      money: financialFund.financial,
      earn: financialFund.financialEarn 
    }
  }
  render() {
      ...
      <View style={styles.container}>
        ...
        <ImageBackground source={FUND_BG} style={styles.bgImage}>
          ...
          <View style={styles.itemCon}>
            ...
            <View style={styles.item}>
              ...
              <Text style={styles.itemFont2}>+198.74</Text>
            </View>
            <View style={styles.item}>
              <Text style={styles.itemFont1}>累计收益（元）</Text>
              <Text style={styles.itemFont2}>+375.30</Text>
            </View>
          </View>
        </ImageBackground>
        {/* grid */}
        ...
        <View style={{ paddingHorizontal: 20 }}>
          ...
          <View style={styles.styleItem}>
            <Text style={styles.itemTitleFont}>日月鑫货币A</Text>
            <View style={{ marginTop: 24, flex: 1, flexDirection: "row", justifyContent: "space-between" }}>
              ...
              <View>
                ...
                <Text style={[styles.itemsFont, { color: '#E93636' }]}>+120.46</Text>
              </View>
            </View>
          </View>
          {/* 中银黄金指数分级 */}
          <View style={styles.styleItem}>
            <Text style={styles.itemTitleFont}>赞多金</Text>
            <View style={{ marginTop: 24, flex: 1, flexDirection: "row", justifyContent: "space-between" }}>
              <View>
                <Text style={styles.itemsTitle}>金额</Text>
                <Text style={styles.itemsFont}>{formatMoney(money/2)}</Text>
              ...
              <View>
                <Text style={styles.itemsTitle}>持有收益</Text>
                <Text style={[styles.itemsFont, { color: '#E93636' }]}>+78.28</Text>
              </View>
            </View>
          </View>
        </View>
