    ...
    return (
      <View style={{flex: 1, position: "relative"}}>
        <View style={{position: "absolute"}}>
          <Image source={BI1} style={{width: '100%', height: '100%'}}></Image>
          <Image source={BI2} style={{width: '100%', height: '100%'}}></Image>
          <Image source={BI3} style={{width: '100%', height: '100%'}}></Image>
        </View>
        <Image source={image} style={{width: '100%', height: '100%'}}></Image>
        <TouchableWithoutFeedback onPress={this.next}>
          <View style={[styles.btn,{top: `${top*100}%`, left: `${left*100}%`}]}></View>
        </TouchableWithoutFeedback>
      </View>
    )
  }
