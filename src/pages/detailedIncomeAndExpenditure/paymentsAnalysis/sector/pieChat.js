...
import { ART, Animated, StyleSheet, View, BVLinearGradient, TouchableWithoutFeedback } from 'react-native';
import Wedge from './wedge/modifyWedge';
    ...
    return (
        <View>
          ...
          <View style={[styles.contentView, {
            width: (this.props.innerRadius) * 2,
            height: (this.props.innerRadius) * 2,
            left: (this.props.outerRadius - this.props.innerRadius),
            top: (this.props.outerRadius - this.props.innerRadius)
          }]}>
            {this.props.children}
          </View>
        </View>
