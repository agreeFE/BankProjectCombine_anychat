        ...
        <ScrollView >
            ...
            <View style={styles.loanItem}>
              <Text style={{color:'#666666'}}> 领卡方式 </Text>
                <View style={styles.loanItemRight}>
                  <Text style={[ styles.useLoan, styles.loanItemRightText,{color:'#E69933'}]}> 网点自取 </Text>
                </View>
            </View>
            <View style={styles.loanItem}>
              <Text style={{color:'#666666'}}> 开户网点 </Text>
                <View style={styles.loanItemRight}>
            ...
            <View style={styles.loanItem}>
              <Text style={{color:'#666666'}}> 具体地址 </Text>
                <View style={styles.loanItemRight}>
                  <Text style={[ styles.useLoan, styles.loanItemRightText]}> 福华三路与金田路交叉口 </Text>
                </View>
            </View>
            <Text style={{paddingLeft:20,paddingRight:20,color:'#999999',marginTop:16}}>新的银行卡在业务办理成功后<Text style={{color:'#E69933'}}>10</Text>个工作日可取</Text>
        </ScrollView>
