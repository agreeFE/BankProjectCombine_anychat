  ...
  render() {
    ...
    return (
      <View style={{backgroundColor: 'rgba(0,0,0,0.30)',width:'100%',height:'100%'}}>
        <View style={{width:'90%',position:'absolute',top:'40%',left:'5%',backgroundColor:'#fff',borderRadius:10,}}>
          <View style={{marginTop:12,marginBottom:30,borderBottomColor:'#ebebeb',borderBottomWidth:1,paddingBottom:12}}>
            <Text style={styles.title}>请输入交易密码</Text>
          </View>
          <View style={{position:"relative"}}>
            <Text style={{width:'100%',textAlign:"center",}}>请输入银行卡 <Text style={{color:'#E39634'}}>{ formatCardNum( window.$globalBankCardNum, 4 ) }</Text>交易密码 </Text>
            <InputScrollView >
                  <View >
