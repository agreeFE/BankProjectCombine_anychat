...
module.exports = class ReportLoss extends Component<{}> {
  ...
  componentDidMount() {
    ...
    //   if( item['FIELDCODE'] == 'ProName'){
    //     _this.setState({
    //       ProName:item['FIELDVALUE']
    //     })
    //   }else if( item['FIELDCODE'] == 'FLAMT'){
    //     _this.setState({
    ...
    return (
      <Close callBackHome = {()=> {this.props.closeHome()}} >
        <View style={{flexDirection:"row",marginTop:32,marginLeft:24,marginBottom:20,alignItems:"center"}}>
          ...
          <Text style={styles.title}>理财购买电子回单</Text>
        </View>
        <ScrollView>
          ...
          <View style={styles.loanItem}>
            <Text> 交易类型 </Text>
              <View style={styles.loanItemRight}>
                <Text style={[ styles.useLoan, styles.loanItemRightText]}>理财购买</Text>
              </View>
          </View>
          <View style={styles.loanItem}>
            <Text> 交易状态 </Text>
          ...
          <View style={styles.loanItem}>
            <Text> 理财名称</Text>
              <View style={styles.loanItemRight}>
                <Text style={[ styles.useLoan, styles.loanItemRightText]}>{window.$globalManageName}</Text>
              </View>
          </View>
          <View style={styles.loanItem}>
            <Text> 交易金额 </Text>
              <View style={styles.loanItemRight}>
                <Text style={[ styles.useLoan, styles.loanItemRightText]}>{formatMoney(window.$globalManageMoney)}</Text>
              </View>
          </View>
          <View style={styles.loanItem}>
            <Text> 交易时间 </Text>
