    ...
    return (
      <Close callBackHome = {()=> {this.props.closeHome()}} >
        <View style={{flexDirection:"row",marginTop:32,marginLeft:24,marginBottom:20,alignItems:"center"}}>
          ...
          <Text style={styles.title}>信用卡激活电子回单</Text>
        </View>
        <ScrollView>
          ...
          <View style={styles.loanItem}>
            <Text> 卡号 </Text>
              <View style={styles.loanItemRight}>
                <Text style={[ styles.useLoan, styles.loanItemRightText]}>6224 **** **** 9999</Text>
              </View>
          </View>
          {/* <View style={styles.loanItem}>
            <Text> 卡类型 </Text>
              <View style={styles.loanItemRight}>
                <Text style={[ styles.useLoan, styles.loanItemRightText]}>信用卡</Text>
              </View>
          </View> */}
          <View style={styles.loanItem}>
            <Text> 交易类型 </Text>
              <View style={styles.loanItemRight}>
                <Text style={[ styles.useLoan, styles.loanItemRightText]}>信用卡激活</Text>
              </View>
          </View>
          <View style={styles.loanItem}>
            <Text> 交易时间 </Text>
