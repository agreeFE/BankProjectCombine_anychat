          ...
          <Close callBackHome = {()=> {this.props.closeHome()}} >
            <View style={{height:this.state.ViewHeight}}>
              <View style={{flexDirection:"row",marginTop:32,marginLeft:24,marginBottom:20,alignItems:"center"}}>
                ...
                <Text style={styles.title}>可开卡片选择</Text>
              </View>
              <ScrollView>
                <View style={styles.item}>
                  <Text>普卡</Text>
                  <Image source={require('$image/cloudTeller/regular-card.png')}></Image>
                </View>
                <View style={styles.item}>
                  <Text>金卡</Text>
                  <Image source={require('$image/cloudTeller/gold-card.png')}></Image>
                </View>
                <View style={styles.item}>
                  <Text>白金卡</Text>
                  <Image source={require('$image/cloudTeller/platinum-card.png')}></Image>
                </View>
              </ScrollView>
              <LinearGradient style={styles.ensure} colors={$globalStyle.buttonLinerBackground}  >
                  <Text style={{color:'#fff',fontSize:17,textAlign:"center",height:45,lineHeight:45}} onPress={() => {
                          this.props.btnState && this.props.addTellerList(2,'我已确认开卡种类。');
